...
import './App.css';
// Author: Dallin Duke
// Description: Create a website that displays a welcoming header and create a class that seperates team info into school, mascot, and location and display that info for every listed team.
...
// Welcome header function
function Welcome(){
  return (<h1>Welcome to the NCAA March Madness Info Website</h1>);
}
// Seperating teams info into school, mascot, and location
...
// Displaying Team Card list
function TeamCardList(){
  return(
    <div>
      {teams.map(oneTeam => <TeamCard {...oneTeam}/>)}
    </div>
  );
}

// Running previous functions inside App
function App() {
  return (
    <div className="App">
